...
mobs:register_mob("livingcavesmobs:grub", {
	...
	runaway = true,
	stay_near = {
		{ "livingcaves:glowshroom_top", "default:bush_leaves", "default:blueberry_bush_leaves",
			"naturalbiomes:cowberrybush_leaves", "naturalbiomes:beach_bush_leaves", "naturalbiomes:outback_bush_leaves" },
		4 },
	jump = false,
	jump_height = 3,
	pushable = true,
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe =
	{ "livingcavesmobs:grub", "default:blueberry_bush_leaves", "default:blueberry_bush_leaves",
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe =
	{ "livingcavesmobs:grub", "naturalbiomes:beach_bush_leaves", "naturalbiomes:beach_bush_leaves",
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe =
	{ "livingcavesmobs:grub", "naturalbiomes:outback_bush_leaves", "naturalbiomes:outback_bush_leaves",
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe =
	{ "livingcavesmobs:mothegg", "naturalbiomes:outback_bush_leaves", "naturalbiomes:outback_bush_leaves",
		"naturalbiomes:outback_bush_leaves" }
})
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe =
	{ "livingcavesmobs:mothegg", "naturalbiomes:beach_bush_leaves", "naturalbiomes:beach_bush_leaves",
		"naturalbiomes:beach_bush_leaves" }
})
...
minetest.register_craft({
	...
	type = "shapeless",
	recipe =
	{ "livingcavesmobs:mothegg", "default:blueberry_bush_leaves", "default:blueberry_bush_leaves",
		"default:blueberry_bush_leaves" }
})
